...
func request_TaskService_TaskChat_0(ctx context.Context, marshaler runtime.Marshaler, client TaskServiceClient, req *http.Request, pathParams map[string]string) (TaskService_TaskChatClient, runtime.ServerMetadata, chan error, error) {
	var metadata runtime.ServerMetadata
...
func RegisterTaskServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TaskServiceClient) error {
	...
	mux.Handle("POST", pattern_TaskService_TaskChat_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, reqErrChan, err := request_TaskService_TaskChat_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
